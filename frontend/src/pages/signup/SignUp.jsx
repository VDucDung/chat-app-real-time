...
const SignUp = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
            <div className="w-full p-6 bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <GenderCheckbox onHandleCheckboxChange={handleCheckboxChange} selectedGender={inputs.gender} />
